# From: https://mastering-shiny-solutions.org. 

# We can add two action buttons prev_story and next_story to iterate through the 
# narrative. We can leverage the fact that whenever you click an action button 
# in Shiny, the button stores how many times that button has been clicked. To 
# calculate the index of the current story, we can subtract the stored count of 
# the next_story button from the previous_story button. Then, by using the 
# modulus operator, we can increase the current position in the narrative while 
# never go beyond the interval [1, length of the narrative].
